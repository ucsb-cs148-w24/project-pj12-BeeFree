...
//                VStack(spacing: 20){
//                    Section(header: Text("Enter your screen time today").foregroundColor(.white)) {
//                        // Combine the hours and minutes picker horizontally
//                        HStack(alignment: .center, spacing: 20) {
//                            // Hours picker
//                            Picker("Hours", selection: $selectedHours) {
//                                ForEach(hours, id: \.self) { hour in
...
//                    }
//                    
//                    // Display the selected screen time
//                    Section {
//                        HStack {
//                            Text("Total Screen Time: ")
//                            Spacer()
