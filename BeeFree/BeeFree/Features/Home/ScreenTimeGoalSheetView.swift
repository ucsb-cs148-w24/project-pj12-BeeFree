        ...
        NavigationStack {
            VStack {
                ...
                VStack{
                    ...
                    Text("Set a total screen time goal for your device. The screen time goal will not affect how BeeFree blocks your app usage. Experts recommend 2 hours/day")
                        .multilineTextAlignment(.center)
                        .padding(EdgeInsets(top: 4, leading: 16, bottom: 0, trailing: 16))
//                    Text("The screen time goal will not affect how BeeFree blocks your app usage.")
